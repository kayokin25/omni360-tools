...
DEMOS.creativeMatch = function (host) {
  ...
  const screens = [
    { t: 'МАЕР · 1280×720', op: 'MAER (Outdoor)', w: 1280, h: 720 },
    { t: 'Russ Outdoor · 1920×1080', op: 'Russ Outdoor', w: 1920, h: 1080 },
    { t: 'Russ Outdoor · 1280×720', op: 'Russ Outdoor', w: 1280, h: 720 },
    { t: 'Оператор · 1080×1920', op: 'РА Прайм', w: 1080, h: 1920 },
    { t: 'Оператор · 960×960', op: 'РА Прайм', w: 960, h: 960 }
  ];
  ...
  /* Правило один в один как в creatives-core: для Russ — точный размер,
     остальным — то же соотношение сторон и размер не меньше экрана,
     из подходящих берётся наименьший. */
  function pick(scr) {
    ...
    return { best: best, rule: 'то же соотношение сторон и размер не меньше экрана' };
  }
